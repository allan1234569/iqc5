...
//                Win_CommConfig.dcb.XoffLim = 500;
//                Win_CommConfig.dcb.XonLim = 500;
//                SetCommConfig(Win_Handle, &Win_CommConfig, sizeof(COMMCONFIG));
//                break;
...
//                break;
        ...
        case FLOW_XONXOFF:
            ...
            Win_CommConfig.dcb.XoffLim = 500;
            Win_CommConfig.dcb.XonLim = 500;
            Win_CommConfig.dcb.XonChar=0x11;
            Win_CommConfig.dcb.XoffChar=0x13;
            SetCommConfig(Win_Handle, &Win_CommConfig, sizeof(COMMCONFIG));
            break;

        case FLOW_RTS_CTS:
            Win_CommConfig.dcb.fOutxCtsFlow=TRUE;
            Win_CommConfig.dcb.fOutxDsrFlow=TRUE;
        ...
        case FLOW_DTR_DSR:
            ...
            Win_CommConfig.dcb.fOutxDsrFlow=FALSE;
            Win_CommConfig.dcb.fRtsControl=RTS_CONTROL_ENABLE;
            Win_CommConfig.dcb.fDtrControl=DTR_CONTROL_HANDSHAKE;
            Win_CommConfig.dcb.fInX=FALSE;
            Win_CommConfig.dcb.fOutX=FALSE;
            SetCommConfig(Win_Handle, &Win_CommConfig, sizeof(COMMCONFIG));
            break;
