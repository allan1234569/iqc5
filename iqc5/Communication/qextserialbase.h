...
//		void validSettings(bool valid);
        ...
        /*!
         * This signal is emitted whenever cts line has changed its state. You may
         * \brief ctsChanged
         * \param status \p true when CTS signal is on, \p false otherwise
         *
         * \see lineStatus()
         *
         */
        void ctsChanged(bool status);
};
