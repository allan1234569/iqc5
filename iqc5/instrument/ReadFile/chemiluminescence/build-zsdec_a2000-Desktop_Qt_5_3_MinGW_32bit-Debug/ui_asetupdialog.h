...
public:
    ...
    QWidget *tab;
    QLabel *label_3;
    QLineEdit *InstallPlace_LineEdit;
    QLabel *label_2;
    QLabel *label;
...
"}"));
        ...
        InstallPlace_LineEdit = new QLineEdit(tab);
        InstallPlace_LineEdit->setObjectName(QStringLiteral("InstallPlace_LineEdit"));
        InstallPlace_LineEdit->setGeometry(QRect(100, 70, 140, 20));
        InstallPlace_LineEdit->setReadOnly(true);
        ...
        DeviceName_LineEdit->setReadOnly(false);
        comboBox = new QComboBox(tab);
        comboBox->setObjectName(QStringLiteral("comboBox"));
        comboBox->setGeometry(QRect(100, 10, 69, 22));
    ...
    void retranslateUi(QDialog *ASetupDialog)
    {
        ...
        label_2->setText(QApplication::translate("ASetupDialog", "\345\256\211\350\243\205\345\234\260\347\202\271\357\274\232", 0));
