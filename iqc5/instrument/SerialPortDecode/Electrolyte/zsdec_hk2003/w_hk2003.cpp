...
W_Hk2003::W_Hk2003(QWidget *parent)
    : BaseWindow(parent)
{
    this->setWindowTitle("电解质-HK2003");
}
...
void W_Hk2003::decode(QString data)
{
    m_sData += data;
                    ...
                    for(int i = 0; i < lsl_unit.size(); i++)
                    {
                        ...
                        else
                        {
                            ...
                            if (li_pos >= 0)
                            {
                                ...
                                ls_item = lsl_unit.at(i).mid(li_pos + 1);
                            }
                            else
                            {
