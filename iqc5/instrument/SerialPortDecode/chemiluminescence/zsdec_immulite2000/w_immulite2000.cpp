#include "w_immulite2000.h"

W_Immulite2000::W_Immulite2000(QWidget *parent)
    : BaseWindow(parent)
{
    this->setWindowTitle("化学发光-IMMULITE");
}

W_Immulite2000::~W_Immulite2000()
{

}

int W_Immulite2000::decode(QString data)
{
    qint32 li_i;
    qint32 li_cnt;
    qint32 li_stx;
...
void W_Immulite2000::calcResult(QString &as_result)
{
    qint32 li_pos;
