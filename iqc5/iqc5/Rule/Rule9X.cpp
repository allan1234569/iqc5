...
Rule9X::Rule9X(QVector<double> &means, QVector<double> &sds, QVector<QVector<Result> > &rnds)
{
    this->means = &means;
    this->sds = &sds;
    this->rnds = &rnds;
...
int Rule9X::GetValidCount(int level)
{
    int vaildCount = 0;
...
bool Rule9X::IsValid(int level, int index)
{
    int InvalidCount = 0;
