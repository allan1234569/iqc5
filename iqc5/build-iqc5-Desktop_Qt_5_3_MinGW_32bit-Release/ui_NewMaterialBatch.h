/********************************************************************************
** Form generated from reading UI file 'NewMaterialBatch.ui'
**
...
#ifndef UI_NEWMATERIALBATCH_H
#define UI_NEWMATERIALBATCH_H
...
public:
    ...
    void setupUi(QMainWindow *NewMaterialBatch)
    {
        if (NewMaterialBatch->objectName().isEmpty())
            NewMaterialBatch->setObjectName(QStringLiteral("NewMaterialBatch"));
        NewMaterialBatch->resize(1144, 600);
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/clipboard.png"), QSize(), QIcon::Normal, QIcon::Off);
        NewMaterialBatch->setWindowIcon(icon);
        centralwidget = new QWidget(NewMaterialBatch);
        ...
        inputMaterialName = new QLineEdit(widget_4);
        inputMaterialName->setObjectName(QStringLiteral("inputMaterialName"));
        inputMaterialName->setGeometry(QRect(510, 20, 141, 20));
        ...
        NewMaterialBatch->setCentralWidget(centralwidget);

        retranslateUi(NewMaterialBatch);

        QMetaObject::connectSlotsByName(NewMaterialBatch);
    } // setupUi

    void retranslateUi(QMainWindow *NewMaterialBatch)
    {
        NewMaterialBatch->setWindowTitle(QApplication::translate("NewMaterialBatch", "\350\264\250\346\216\247\345\223\201\346\211\271\351\207\217\346\226\260\345\273\272", 0));
        groupBox_3->setTitle(QString());
        btnAdd->setText(QString());
        btnDelete->setText(QString());
        btnOK->setText(QApplication::translate("NewMaterialBatch", "\344\277\235\345\255\230", 0));
        btnCancel->setText(QApplication::translate("NewMaterialBatch", "\345\205\263\351\227\255", 0));
        label_6->setText(QApplication::translate("NewMaterialBatch", "\346\211\271\345\217\267:", 0));
        label_2->setText(QApplication::translate("NewMaterialBatch", "\345\216\202\345\256\266:", 0));
        label_3->setText(QApplication::translate("NewMaterialBatch", "\344\272\247\345\234\260:", 0));
        inputDescription->setText(QString());
        label_7->setText(QApplication::translate("NewMaterialBatch", "\346\263\250\345\206\214\345\217\267:", 0));
        pushButton->setText(QApplication::translate("NewMaterialBatch", "\346\237\245\350\257\242", 0));
        lblTestTypeInfo_3->setText(QApplication::translate("NewMaterialBatch", "\350\264\250\346\216\247\345\223\201\345\220\215\347\247\260:", 0));
    } // retranslateUi

};

namespace Ui {
    class NewMaterialBatch: public Ui_NewMaterialBatch {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_NEWMATERIALBATCH_H
