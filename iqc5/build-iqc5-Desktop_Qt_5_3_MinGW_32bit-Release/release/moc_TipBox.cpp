...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TipBox_t, stringdata) + ofs \
...
const QMetaObject TipBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TipBox.data,
      qt_meta_data_TipBox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TipBox.stringdata))
        return static_cast<void*>(const_cast< TipBox*>(this));
