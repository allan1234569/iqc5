...
#include "../../iqc5/LoginMainWindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LoginMainWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 60, 10)
    ...
    "LoginMainWindow\0correct_login_password\0"
    "\0slt_login\0showLogin\0showRegist"
};
...
void LoginMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slt_login(); break;
        case 2: _t->showLogin(); break;
        case 3: _t->showRegist(); break;
        default: ;
        }
        ...
        {
            typedef void (LoginMainWindow::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoginMainWindow::correct_login_password)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void LoginMainWindow::correct_login_password()
{
