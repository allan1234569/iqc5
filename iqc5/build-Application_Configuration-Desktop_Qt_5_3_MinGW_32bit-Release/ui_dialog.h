...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        pushButton_SelectDataDb->setGeometry(QRect(370, 110, 30, 20));
        label_26 = new QLabel(groupBox_21);
        label_26->setObjectName(QStringLiteral("label_26"));
        label_26->setGeometry(QRect(20, 110, 54, 20));
        label_36 = new QLabel(groupBox_21);
        label_36->setObjectName(QStringLiteral("label_36"));
        label_36->setGeometry(QRect(20, 150, 54, 20));
        label_37 = new QLabel(groupBox_21);
        label_37->setObjectName(QStringLiteral("label_37"));
        label_37->setGeometry(QRect(20, 190, 54, 20));
        lineEdit_2 = new QLineEdit(groupBox_21);
        lineEdit_2->setObjectName(QStringLiteral("lineEdit_2"));
        lineEdit_2->setGeometry(QRect(80, 150, 140, 20));
        lineEdit_3 = new QLineEdit(groupBox_21);
        lineEdit_3->setObjectName(QStringLiteral("lineEdit_3"));
        lineEdit_3->setGeometry(QRect(80, 190, 140, 20));
        ...
        pushButton_SelectDbPath->setGeometry(QRect(360, 50, 30, 20));
        ...
        pushButton_browse->setGeometry(QRect(360, 80, 30, 20));
        ...
        lineEdit_OnlineIniPath->setGeometry(QRect(110, 50, 250, 20));
        ...
        lineEdit_ParserIniPath->setGeometry(QRect(110, 80, 250, 20));
...
"border-color: rgb(48, 221, 255);"));
        ...
        QWidget::setTabOrder(lineEdit_InstallPlace, lineEdit_DeviceName);
        QWidget::setTabOrder(lineEdit_DeviceName, lineEdit);
        QWidget::setTabOrder(lineEdit, pushButton_PreStep);
        QWidget::setTabOrder(pushButton_PreStep, pushButton_NextStep);
        QWidget::setTabOrder(pushButton_NextStep, pushButton_Cancel);
        QWidget::setTabOrder(pushButton_Cancel, comboBox_PortName);
        QWidget::setTabOrder(comboBox_PortName, radioButton_Clietnt);
        QWidget::setTabOrder(radioButton_Clietnt, radioButton_SerialComm);
        ...
        QWidget::setTabOrder(radioButton_Log, toolButton_4);
        QWidget::setTabOrder(toolButton_4, comboBox_DataBits);
        QWidget::setTabOrder(comboBox_DataBits, comboBox_StopBits);
        QWidget::setTabOrder(comboBox_StopBits, radioButton_Server);
        ...
        QWidget::setTabOrder(toolButton_2, toolButton_1);
        QWidget::setTabOrder(toolButton_1, radioButton_Database);
        QWidget::setTabOrder(radioButton_Database, comboBox_Parity);
        QWidget::setTabOrder(comboBox_Parity, comboBox);
        QWidget::setTabOrder(comboBox, lineEdit_DataDbPath);
        QWidget::setTabOrder(lineEdit_DataDbPath, pushButton_SelectDataDb);
        QWidget::setTabOrder(pushButton_SelectDataDb, comboBox_BuadRate);
        QWidget::setTabOrder(comboBox_BuadRate, pushButton_save);
        QWidget::setTabOrder(pushButton_save, lineEdit_LogPath);
        QWidget::setTabOrder(lineEdit_LogPath, PushButton_SelectLogPath);
        QWidget::setTabOrder(PushButton_SelectLogPath, pushButton_SelectDbPath);
        QWidget::setTabOrder(pushButton_SelectDbPath, lineEdit_ServerDb);
        QWidget::setTabOrder(lineEdit_ServerDb, radioButton_LocalServer);
        QWidget::setTabOrder(radioButton_LocalServer, radioButton_RemoteServer);
        QWidget::setTabOrder(radioButton_RemoteServer, lineEdit_Port);
        QWidget::setTabOrder(lineEdit_Port, lineEdit_UserName);
        QWidget::setTabOrder(lineEdit_UserName, lineEdit_Password);
        QWidget::setTabOrder(lineEdit_Password, pushButton_browse);
        QWidget::setTabOrder(pushButton_browse, radioButton_UseDefaultPath);
        QWidget::setTabOrder(radioButton_UseDefaultPath, lineEdit_OnlineIniPath);
        QWidget::setTabOrder(lineEdit_OnlineIniPath, radioButton_CustomPath);
        QWidget::setTabOrder(radioButton_CustomPath, lineEdit_ParserIniPath);
        QWidget::setTabOrder(lineEdit_ParserIniPath, lineEdit_2);
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        label_36->setText(QApplication::translate("Dialog", "\347\224\250\346\210\267\345\220\215\357\274\232", 0));
        label_37->setText(QApplication::translate("Dialog", "\345\257\206\347\240\201 \357\274\232", 0));
